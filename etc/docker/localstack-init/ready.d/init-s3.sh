...
awslocal s3api create-bucket --bucket avatars || true
awslocal s3api put-bucket-cors --bucket avatars --cors-configuration file:///config/s3_bucket_cors_rules.json || true
echo "S3 buckets (media, expense-reports, avatars) initialized"
