defmodule YscWeb.EventDetailsLive do
                        ...
                        <p>
                          ...
                          <%= cond do %>
                            <% @current_user.state == :pending_approval -> %>
                              Your application is still under board review. After the board approves you and your dues are paid, you can buy tickets for this event.
                            <% @had_membership? -> %>
        ...
        <div class="flex flex-col items-center justify-center py-16 space-y-6">
          <div class="text-center">
            ...
            <p class="text-zinc-600 max-w-md">
              You have 5 minutes to complete your purchase. Time ran out, so your ticket selection was released and may no longer be available.
    ...
    cond do
      is_nil(ticket_order) ->
        {:noreply,
         ...
         |> YscWeb.Flash.put_toast(
           :error,
           "This ticket checkout is no longer available.",
           title: "Tickets"
         )
         |> assign(:show_free_ticket_confirmation, false)}
  ...
  defp cancelled_order_error_message(ticket_order) do
    if payment_failure_cancellation?(ticket_order.cancellation_reason) do
      ...
      "This ticket checkout was cancelled. Please choose your tickets again."
    end
  end
