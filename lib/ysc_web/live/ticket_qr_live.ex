defmodule YscWeb.TicketQrLive do
  ...
  def handle_async(:load_ticket_data, {:ok, :not_found}, socket) do
    {:noreply,
     ...
     |> put_flash(
       :error,
       "We couldn't find those tickets. They may have expired or belong to another account. Click your name in the top-right corner, open My Bookings & Payments, then choose Your event tickets — or browse events to buy tickets again."
     )
